        ...
        <ul className="navbar-nav ms-auto mt-2 mt-lg-0">
          {[
            ...
            <li className="nav-item" key={index}>
              <span className="nav-link fw-semibold" onClick={() => handleNavLinkClick(item.path)}>
                {item.label}
              </span>
            </li>
          ))}
          ...
          <li className="nav-item">
            <span className="nav-link fw-semibold no-wrap" onClick={() => handleNavLinkClick("/contact")}>
              Contact Us
            </span>
          </li>
        </ul>
